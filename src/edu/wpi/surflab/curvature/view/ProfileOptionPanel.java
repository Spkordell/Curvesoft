...
public class ProfileOptionPanel extends JPanel implements ActionListener {

	private static ProfileOptionPanel profileOptionPanel;
	...
	private ProfileOptionPanel(final MainController mainController) {	
	...
	*/ 
	...
	public static ProfileOptionPanel getInstance(MainController mainController) {
		if (profileOptionPanel == null) {
			profileOptionPanel = new ProfileOptionPanel(mainController);
		}
		return profileOptionPanel;
	}
	
	public static ProfileOptionPanel getInstance() {
		return profileOptionPanel;
	}
